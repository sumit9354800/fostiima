      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">
            Final <span className="text-[#c31e3b]">Placements</span>
          </h1>
          ...
          {/* Batch Information */}
          <div className="mt-9 inline-flex items-center gap-3 border border-[#1d3559] bg-[#0b2348] px-5 py-4">
            <TrendingUp className="h-5 w-5 text-[#e5b83f]" />
