...
export default function MobileMenu() {
  ...
  return (
    <>
      <div className="flex h-[68px] items-center justify-between border-b border-slate-200 bg-white px-5 lg:hidden">
        <Link
          href="/"
          onClick={closeMenu}
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center border border-slate-200 text-[#123b79] transition-colors hover:border-[#c31e3b] hover:text-[#c31e3b]"
      ...
      <aside
        className={`fixed right-0 top-0 z-[110] flex h-dvh w-[min(88vw,390px)] flex-col bg-white shadow-2xl transition-transform duration-300 lg:hidden ${
