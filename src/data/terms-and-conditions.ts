...
export const termsAndConditionsData: TermsSection[] = [
  {
    ...
    title: "Terms of Use",
    paragraphs: [
      "These Terms of Use apply to all visitors to and users of the site, including any mobile version. By accessing or using the site, you signify that you have read, understand and agree to be bound by these Terms of Use. You also agree to be bound by these Terms of Use, if you post FOSTIIMA.org links on your site.",
  ...
  },
  {
    ...
    title: "Privacy",
    paragraphs: [
      "We care about the privacy of our users. FOSTIIMA has established a Privacy Policy to govern how user information is collected and used. By registering, accessing or using the site, you are signifying your acknowledgement and agreement with FOSTIIMA’s Privacy Policy. See the FOSTIIMA.org footer to view the Privacy Policy.",
    ],
  },
  {
    id: "disclaimers",
  ...
  },
  {
    ...
    points: [
      "Harvest or collect email addresses or other contact information of other users for the purposes of sending unsolicited emails or other unsolicited communications. Solicit other users to join or become members of any commercial online service or other organization without our prior written approval.",
      ...
      "Upload, post, transmit, share, store or otherwise make available content that would constitute, encourage or provide instructions for a criminal offence, violate the rights of any party, or that would otherwise create liability or violate any municipal, provincial, federal or international law.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "By posting user content to any part of the site, you automatically grant, and you represent and warrant that you have the right to grant, to us an irrevocable, perpetual, non-exclusive, transferable, fully paid, worldwide license (with the right to sub license) to use, copy, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part) and distribute such user content for any purpose. You waive any and all claims you may now or later have in any jurisdiction to “moral rights” or equivalent rights of authorship with respect to the user content. You may remove your user content from the site at any time. If you choose to remove your user content, the license granted above will automatically expire, however you acknowledge that we may retain archived copies of your user content.",
    ],
  },
  {
    id: "mobile-services",
    ...
    paragraphs: [
      "By using the mobile services, you agree that we may communicate with you regarding FOSTIIMA.org and other entities by SMS, MMS, text message or other electronic means to your mobile device and that certain information about your usage of the mobile services may be communicated to us.",
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Proprietary Rights in Site Content; Limited License",
    paragraphs: [
      "All content on the site and available through the service, including designs, text, graphics, pictures, video, information, applications, software, music, sound and other files, and their selection and arrangement, are the property of FOSTIIMA, its users or its licensors with all rights reserved. You are granted a limited license to access and use the site and the site’s content and to download or print a copy of any portion of the site’s content to which you have properly gained access solely for your personal, non-commercial use, provided that you keep all copyright or other proprietary notices intact.",
    ],
  },
  {
    id: "trademarks",
    title: "Trademarks",
    paragraphs: [
      "FOSTIIMA.org, and other graphics, logos, designs, page headers, button icons, scripts and service names are registered trademarks, trademarks in India and/or other countries. Our trademarks may not be used, including as part of trademarks and /or as part of domain names, in connection with any product or service in any manner that is likely to cause confusion and may not be copied, imitated, or used, in whole or in part, without our prior written permission.",
    ],
  },
  {
    id: "termination",
